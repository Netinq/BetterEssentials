...
namespace BetterEssentials
{
    public class Base
    {
        ...
        internal BetterEssentials instance;

        public virtual void Init(BetterEssentials instance, LifeServer server)
        {
            this.server = server;
        ...
        public virtual void registerCheckpoint(Player player) { }
